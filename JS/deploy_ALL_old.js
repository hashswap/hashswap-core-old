...
async function testBlockchain() {
  try {
    ...
    const code = read('../Scilla/Oracle.scilla');
    ...
    console.log('\n');
    console.log('Deploying Register - Oracle address hardcoded in the Register');

    // read Register file and replace Oracle address
