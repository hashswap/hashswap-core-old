...
async function run()
{
    ...
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
    // 1. Call "ReplaceSponsor" from Launcher
    // -  Called by Sponsors
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
...
*/
    ...
    var transition = 'ReplaceSponsor';
    
    await increaseAllowance(CONTRACTS.HUSD, CONTRACTS.Launcher, sponsor2, husd_amount);
    ...
    var gas = Long.fromNumber(50000);
    var tx = await sc_call(Launcher, transition, args, sponsor2, gas);
