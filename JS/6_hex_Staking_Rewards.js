...
async function run()
{
    ...
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
    // 1. Call "AddLiquidity" to HEX Again to check staking reward calculation 
    // -  Called by Traders
    // -  Traders also need to call "IncreaseAllowance" from HUSD
    //    and Token both to give funds to HEX
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
   
 
    console.log("Trader Address === ", trader1_Address);
    ...
    var min_lp = 1;
    var husd_amount = 10000;
    var max_token_amount = 3000;
    
    await increaseAllowance(CONTRACTS.HUSD, CONTRACTS.HEX, trader1, husd_amount);
    await increaseAllowance(CONTRACTS[influencer1_Address], CONTRACTS.HEX, trader1, max_token_amount);
    ...
    { vname: 'husd_amount', type: 'Uint128', value: husd_amount.toString() },
    ...
    var st = await HUSD.getState();
    consoleLog( "HUSD STATE AFTER ADD LIQUIDITY AGAIN ", st, "", "");
