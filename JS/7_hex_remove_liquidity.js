...
*/
    var contribution_amount = 15000;
    var min_husd_amount = 1;
    var min_token_amount = 1;

    var transition = 'RemoveLiquidity';
    var args = [
    ...
    { vname: 'min_husd_amount', type: 'Uint128', value: min_husd_amount.toString() },
