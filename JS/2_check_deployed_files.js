...
async function run()
{
		...
		//CORE CONTRACTS 
		var Oracle = await setup.zilliqa.contracts.at(CONTRACTS.Oracle);
		var Register = await setup.zilliqa.contracts.at(CONTRACTS.Register);
		var HUSD = await setup.zilliqa.contracts.at(CONTRACTS.HUSD);
		var HEX = await setup.zilliqa.contracts.at(CONTRACTS.HEX);
		var Launcher = await setup.zilliqa.contracts.at(CONTRACTS.Launcher);
    ...
    console.log(CONTRACTS.HEX);
   
   
    var test = await setup.zilliqa.blockchain.getSmartContractCode(CONTRACTS.HEX);
    console.log(test);
    console.log(CONTRACTS.HEX);
